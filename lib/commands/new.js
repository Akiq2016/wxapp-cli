...
function generateWxaConfig(options) {
  var requiredFields = ['projectname', 'projectDir', 'pkg', 'scripts', 'style'];
  var res = requiredFields.reduce(function(acc, v) {
    return (0,
    _objectSpread4.default)({}, acc, (0, _defineProperty2.default)({}, v, options[v]));
  }, {});
  (0, _fsExtra.writeFileSync)(
    (0, _path.join)(options.projectDir, 'wxa.config.js'),
    'module.exports = '.concat(JSON.stringify(res, null, 2), ';\n')
  );
}
